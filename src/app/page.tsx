...
const ENDPOINTS = [
  ...
  { method: 'GET' as const, path: '/api/company-context (GET query or POST JSON; companyId optional)' },
  { method: 'POST' as const, path: '/api/company-context' },
  { method: 'GET' as const, path: '/api/services-search (GET query or POST JSON; companyId optional)' },
  { method: 'POST' as const, path: '/api/services-search' },
  { method: 'GET' as const, path: '/api/intake-flow (GET query or POST JSON; companyId optional)' },
  { method: 'POST' as const, path: '/api/intake-flow' },
